...
<nav class="sticky top-0 z-50 w-full px-4 py-3 flex justify-between items-center bg-base-100/70 sm:bg-base-300/70 shadow-lg transition-all duration-300 ease-in-out">
	<!-- Brand -->
